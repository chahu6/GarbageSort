...
6. web 端启动：使用 IDEA 开发工具打开`web`目录，修改`application-druid.yml` 配置文件中的数据据信息，运行 `WebApplication.java`，启动 web 垃圾分类管理系统，启动成功，可以直接访问 http://localhost:8082 。账号/密码：admin/admin123
